    ...
    const gitApi = nock('https://api.github.com', {
        ...
        .reply(200, {
            items: [{
                ...
                // {
                //     "name": "bootcamp-step-2",
                //     "full_name": "orennitzan/bootcamp-step-2",
                // }
            ]
        });

    let res = await api.searchRepositories({ q: 'bootcamp-step-1 in:name' });
...
test('Contributors should indicate 1 contributor', async () => {
    ...
    let res = await api.getContributors('orennitzan/bootcamp-step-1', {});
